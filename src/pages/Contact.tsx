        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              {/* UPDATED BUSINESS HOURS: Premium Maroon & Gold Theme */}
              <div className="bg-[#5D0000] rounded-2xl p-8 shadow-2xl relative overflow-hidden border border-gold/20">
                <div className="absolute top-0 right-0 p-4 opacity-10">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      <span className="text-white/70 text-sm">Monday — Sunday</span>
                      <span className="text-gold font-bold">9:00 AM — 10:00 PM</span>
                    </div>
                    <div className="flex items-center gap-2 pt-2">
                      <CheckCircle2 className="w-4 h-4 text-gold" />
                      <p className="text-xs text-white/60 italic">Open all days including public holidays</p>
                    </div>
                  </div>
                </div>
              </div>
